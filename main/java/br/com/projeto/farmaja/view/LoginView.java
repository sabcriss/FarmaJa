...
public class LoginView {
    ...
    public boolean realizarLogin(String tipoUsuario) {
        ...
        if (tipoUsuario.equals("Cliente") && email.equals("cliente") && senha.equals("123")) {
            System.out.println("Login como Cliente bem-sucedido!");
            return true;
        }

        if (tipoUsuario.equals("Admin") && email.equals("admin") && senha.equals("123")) {
            System.out.println("Login como Admin bem-sucedido!");
            return true;
        }

        if (tipoUsuario.equals("Entregador") && email.equals("entregador") && senha.equals("123")) {
